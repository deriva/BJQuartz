...
! function(t) {
	...
	r.prototype.cache = n, r.prototype.define = function(t, e) {
		...
		function c(t, e) {
			...
			("load" === t.type || r.test((t.currentTarget || t.srcElement).readyState)) && (n.modules[d] = e, y
				.removeChild(m),
				function o() {
					return ++v > 1e3 * n.timeout / 4 ? a(d + " is not a valid module", "error") : void(n.status[d] ?
						s() : setTimeout(o, 4))
				}())
		}
		...
		var p = this,
			...
			y = e.getElementsByTagName("head")[0];
		t = function() {
		...
		if (l = l || [], n.host = n.host || (f.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 ===
			t.length || layui["layui.all"] && u[d]) return s(), p;
		var h = (u[d] ? f + "modules/" : /^\{\/\}/.test(p.modules[d]) ? "" : n.base || "") + (p.modules[d] || d) +
			".js";
		if (h = h.replace(/^\{\/\}/, ""), !n.modules[d] && layui[d] && (n.modules[d] = h), n.modules[d]) !
			function g() {
				return ++v > 1e3 * n.timeout / 4 ? a(d + " is not a valid module", "error") : void("string" ==
					typeof n.modules[d] && n.status[d] ? s() : setTimeout(g, 4))
			}();
		else {
			...
			m.async = !0, m.charset = "utf-8", m.src = h + function() {
				...
				return t ? "?v=" + t : ""
			}(), y.appendChild(m), !m.attachEvent || m.attachEvent.toString && m.attachEvent.toString().indexOf(
				"[native code") < 0 || i ? m.addEventListener("load", function(t) {
				c(t, h)
		...
		var c = (o || t).replace(/\.|\//g, ""),
			s = u.id = "layuicss-" + c,
			p = 0;
		return u.rel = "stylesheet", u.href = t + (n.debug ? "?v=" + (new Date).getTime() : ""), u.media = "all", e
			.getElementById(s) || l.appendChild(u), "function" != typeof r ? i : (function f() {
				return ++p > 1e3 * n.timeout / 100 ? a(t + " timeout") : void(1989 === parseInt(i.getStyle(e
					.getElementById(s), "width")) ? function() {
					r()
				}() : setTimeout(f, 100))
			}(), i)
...
! function() {
	...
	r.prototype = [], r.prototype.constructor = r, n.extend = function() {
		...
		c.rel = "stylesheet", c.href = t, c.id = a, e.getElementById(a) || i.appendChild(c), "function" ==
			typeof r && ! function l() {
				return ++s > 80 ? window.console && console.error(u + ".css: Invalid") : void(1989 === parseInt(n
					.getStyle(e.getElementById(a), "width")) ? r() : setTimeout(l, 100))
			}()
		...
		if (r) {
			...
			var i = "right" === o.clickType ? function() {
				...
				f = i.left,
				p = i.bottom;
			f + c + l > s("width") && (f = s("width") - c - l), p + u + l > s() && (i.top > u + l ? p = i.top - u -
				2 * l : "right" === o.clickType && (p = s() - u - 2 * l, p < 0 && (p = 0)));
			var h = o.position;
			if (h && (r.style.position = h), r.style.left = f + ("fixed" === h ? 0 : a(1)) + "px", r.style.top = p +
				("fixed" === h ? 0 : a()) + "px", !n.hasScrollbar()) {
		...
		r.ready(function() {
			...
			if (t[0]) {
				...
				t.data("isOutAnim") && t.addClass("layer-anim " + a), i(
					...
					.rescollbar(e), t.attr("minLeft") && (o.minIndex--, o.minLeft.push(t.attr("minLeft"))),
...
layui.define(["jquery", "laytpl", "lay"], function(e) {
	...
	k.prototype.config = {
		...
		var t = ".layui-menu:not(.layui-dropdown-menu) li";// ".layui-menu:not(.layui-dropdown-menu) li"
					...
					var c = d.field || e,
						s = function() {
							var e = d.totalRowText || "",
								...
								i = {};
							return i[c] = t, t = u(d, t, i), a ? a[d.field] || e : d.totalRow ? t || e :
								e
						}(),
