       ...
       */
        ...
        listen: function (options) {
            ...
            $('body').on('click', '[layuimini-href]', function () {
                ...
                if (el.length) {
                    //点击的时候只显示一个
                    //$(el).closest(".layui-nav-tree").find(".layui-nav-itemed").removeClass("layui-nav-itemed");
                    //$(el).closest(".layui-nav-item").addClass("layui-nav-itemed");
