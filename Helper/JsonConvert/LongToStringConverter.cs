...
{
    public class CustomContractResolver : DefaultContractResolver// CamelCasePropertyNamesContractResolver
    ...
    /// <summary>
    /// Long类型Json序列化重写
    /// 在js中传输会导致精度丢失，故而在序列化时转换成字符类型</summary>
    public class LongToStringConverter : JsonConverter
    {
        ...
        public LongToStringConverter(NumberConverterShip ship)
        {
            _ship = ship;
        }
